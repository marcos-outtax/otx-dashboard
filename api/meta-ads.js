...
// CORREÇÕES:
//  - EXIGE sessão válida (era aberto: vazava dados financeiros)
//  - CORS restrito por allowlist
//  - Removidos headers X-Meta-Token/X-Meta-Account (token só do servidor)
// ============================================================
...
export default async function handler(req, res) {
  ...
  // Token e accountId APENAS via env (não aceita mais via header,
  // que permitia trocar a conta consultada de fora)
